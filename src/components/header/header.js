        ...
        return (
            <div className="col-4 p-0">
                <div className="header border rounded shadow-sm p-3 mr-3 sticky-top">
                    ...
                    <Link to="/systems-project/razdel-1/glava-1" className="clear-style"><li className="list-group-item mt-3 border-top-0 border-dark"><strong>1 Описание процесса трудоустройства</strong></li></Link>
                    ...
                    <Link to="/systems-project/razdel-2/glava-1" className="clear-style"><li className="list-group-item mt-3 border-top-0 border-dark"><strong>2 Описание информационных потоков</strong></li></Link>
                    ...
                    <Link to="/systems-project/razdel-3/glava-1" className="clear-style"><li className="list-group-item mt-3 border-top-0 border-dark"><strong>3 Построение функциональной модели</strong></li></Link>
